...
const SYSTEM_NODES = [
  { id: 'agent-loops', label: 'Agent loops', x: 42, y: 13, tone: 'blue' },
  { id: 'tool-protocols', label: 'Tool protocols', x: 22, y: 45, tone: 'cyan' },
  { id: 'orchestration', label: 'Orchestration', x: 43, y: 45, tone: 'cyan active' },
  { id: 'memory', label: 'Memory', x: 64, y: 45, tone: 'green' },
  { id: 'evaluation', label: 'Evaluation', x: 34, y: 75, tone: 'indigo' },
  { id: 'product-systems', label: 'Product systems', x: 56, y: 75, tone: 'blue' },
];
...
export function renderIndex(articles) {
  ...
  const datePublished = sorted[sorted.length - 1]?.date ?? dateModified;
...
<link rel="canonical" href="https://kiralearn.space/">
<link rel="icon" href="/favicon.svg" type="image/svg+xml">
<!-- Open Graph -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://kiralearn.space/">
<meta property="og:title" content="Kira Learn — Mapping the agentic systems stack">
<meta property="og:description" content="A public study console for AI agents, orchestration, systems design, and the architecture patterns behind the tools.">
<meta property="og:image" content="https://kiralearn.space/assets/og-image.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="Kira Learn live study console with an agentic systems map.">
<meta property="og:site_name" content="Kira Learn">
<!-- Twitter card -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Kira Learn — Mapping the agentic systems stack">
<meta name="twitter:description" content="A public study console for AI agents, orchestration, systems design, and the architecture patterns behind the tools.">
<meta name="twitter:image" content="https://kiralearn.space/assets/og-image.png">
<meta name="twitter:image:alt" content="Kira Learn live study console with an agentic systems map.">
<!-- Structured data -->
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "WebSite",
      "@id": "https://kiralearn.space/#website",
      "url": "https://kiralearn.space/",
      "name": "Kira Learn",
      "description": "A public study console for AI agents, orchestration, systems design, and the architecture patterns behind the tools.",
      "datePublished": "${datePublished}",
      "dateModified": "${dateModified}",
      "publisher": { "@id": "https://kiralearn.space/#author" },
      "potentialAction": {
        "@type": "SearchAction",
        "target": {
          "@type": "EntryPoint",
          "urlTemplate": "https://kiralearn.space/?q={search_term_string}"
        },
    ...
    {
      "@type": "Person",
      "@id": "https://kiralearn.space/#author",
      "name": "Eli Azulai",
      "url": "https://kiralearn.space/",
      "sameAs": [
        "https://github.com/eliAzulai"
      ],
      "knowsAbout": ["AI agents", "agentic systems", "orchestration", "systems design", "LLMs"]
    },
    {
      "@type": "LearningResource",
      "@id": "https://kiralearn.space/#learning-resource",
      "name": "Kira Learn — Agentic Systems Study Console",
      "description": "Structured learning paths covering agentic architecture, systems design, tool protocols, orchestration, evaluation, and product systems.",
      "url": "https://kiralearn.space/",
      "provider": { "@id": "https://kiralearn.space/#author" },
      "educationalLevel": "Advanced",
      "datePublished": "${datePublished}",
      "dateModified": "${dateModified}",
      "teaches": ["AI agent design", "orchestration patterns", "tool protocols", "agentic architecture", "systems evaluation"],
      "inLanguage": "en"
    }
  ]
}
...
function renderSystemMap() {
  const nodes = SYSTEM_NODES.map((node) => {
    ...
    return `<div class="map-node node-${node.id} tone-${primaryTone}${active}" style="--x:${node.x}%;--y:${node.y}%">
  ...
  return `<section class="system-map" id="current-map" aria-label="Current system map">
    <div class="map-legend" aria-label="Map relationship legend">
      <span><i aria-hidden="true"></i>depends on</span>
      <span><i aria-hidden="true"></i>influences</span>
      <span><i aria-hidden="true"></i>observes</span>
    </div>
    ...
    ${nodes}
    <aside class="map-question">
      <span>Current question</span>
      <p>When does agent orchestration become product architecture?</p>
      <dl>
        <div><dt>Focus</dt><dd>Orchestration boundaries, composability, and operational leverage.</dd></div>
        <div><dt>Status</dt><dd>Updated just now</dd></div>
      </dl>
    </aside>
...
function renderStyles() {
  ...
  :root {
    ...
    --color-panel-quiet: rgba(8, 17, 27, 0.5);
    ...
    --size-hero-copy-max: 27.5rem;
    --size-map-min: 45rem;
    --size-map-height: 22.5rem;
    --size-map-height-tablet: 23.75rem;
    --size-map-height-mobile: 28.75rem;
    --size-map-height-first-mobile: 38rem;
    --size-node-min: 9.25rem;
    --size-question: 13rem;
    --size-legend: 8.5rem;
    --size-mini-map: 10.25rem;
    ...
    --space-8xl: 2.125rem;
    --space-9xl: 2.625rem;
    --space-map-controls-first-mobile: 12.5rem;
    --radius-sm: 0.25rem;
    --radius-md: 0.375rem;
    --radius-lg: 0.5rem;
    --type-xs: 0.625rem;
    ...
    --type-display: clamp(2.5rem, 3.4vw, 3.2rem);
    --line-tight: 1.04;
    --line-copy: 1.65;
    --line-body: 1.5;
  ...
  * {
  ...
  .hero {
    min-height: 23.75rem;
    display: grid;
    grid-template-columns: minmax(var(--size-hero-copy-min), var(--size-hero-copy-max)) minmax(var(--size-map-min), 1fr);
    gap: var(--space-7xl);
    align-items: center;
    padding: var(--space-xl) var(--space-0) var(--space-md);
  }
  .hero > *,
  .panel,
  .notes-index {
  ...
  .map-legend span:nth-child(3) i {
    background: repeating-linear-gradient(90deg, var(--color-muted) 0, var(--color-muted) var(--space-xs), var(--color-transparent) var(--space-xs), var(--color-transparent) var(--space-md));
  }
  .map-question {
    top: var(--space-7xl);
    right: var(--space-2xl);
  ...
  .map-question p {
    margin: var(--space-xl) var(--space-0) var(--space-xl);
  ...
  .map-question dd {
    margin: var(--space-2xs) var(--space-0) var(--space-0);
    color: var(--color-muted);
    font-size: var(--type-sm);
  }
  .mini-map {
  ...
  .mini-map span:nth-child(1) {
    inset: var(--space-xl) 42% auto var(--space-2xl);
    height: var(--space-md);
  }
  .mini-map span:nth-child(2) {
    inset: 38% var(--space-6xl) auto 50%;
    height: var(--space-md);
  }
  .mini-map span:nth-child(3) {
    inset: 58% 32% auto var(--space-6xl);
    height: var(--space-md);
  }
  ...
  @media (max-width: 33.75rem) {
    ...
    .system-map {
      min-height: var(--size-map-height-first-mobile);
    }
    .map-node {
    ...
    .map-controls {
      bottom: var(--space-map-controls-first-mobile);
    }
    .cluster-grid {
      grid-template-columns: 1fr;
    }
